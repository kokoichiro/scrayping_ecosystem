...
checkers = ['NLSN','SCOR','AAPL','MSFT','GOOG','AMZN','ORCL','T','OMC','TWTR','BA','BAC','BRK.A','BRK.B','GS','GM','tsla','CAT','FIT','CVX','BABA','NFLX','DIS','PG','FB','SBUX','NVDA','ACN','GE','ADBE','NKE','KO']
...
for checker in checkers:
	...
	try:
			#subsub=subprocess.check_output(['python',cmd,checker],shell=False)
			#print(type(subsub))
